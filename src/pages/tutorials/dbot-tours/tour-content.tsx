...
export const DBOT_ONBOARDING_MOBILE: TMobileTourConfig[] = [
    {
        header: <Localize i18n_default_text='Welcome to ArkTraders Hub' />,
        content: [
            <span key='get-started-on-deriv-bot-wrapper'>
                <Localize
                    key='get-started-on-deriv-bot'
                    i18n_default_text="Let's take a quick tour to discover how ArkTraders Hub works. Press <0>Start</0> to begin."
                    components={[<strong key={0} />]}
                />
            </span>,
        ],
...
export const onboarding_tour_header = (
    <Localize key='onboarding-tour-header' i18n_default_text='Welcome to ArkTraders Hub' />
);
